...
def extract_player_data(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # ========== AVATAR: USE headPic (NOT avatarId) ==========
...
def process_banner_image(headPic_bytes: Optional[bytes],
    ...
    # Layout: player name (wrapped) then guild name
    ...
    # Guild name directly below (no extra large gap for standard layout)
    if player["guild"]:
...
async def get_banner(uid: str):
    try:
        ...
        # Fetch images using headPic and banner_id
